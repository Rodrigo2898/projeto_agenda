...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Open+Sans:wght@300&family=Titillium+Web:wght@200&display=swap);"]);
// Module
___CSS_LOADER_EXPORT___.push([module.id, ":root {\n\t--primary-color:  rgb(13, 106, 134);\n\t--primary-color-dark:  rgb(9, 48, 56);\n}\n\n* {\n\tbox-sizing: border-box;\n\toutline: none;\n}\n\nbody {\n\tmargin: 0;\n\tpadding: 0;\n\tbackground: var(--primary-color);\n\tfont-family: 'Open sans';\n\tfont-size: 1.3em;\n\tline-height: 1.5;\n}\n\n.container {\n\tmax-width: 640px;\n\tmargin: 50px auto;\n\tbackground: #ffff;\n\tpadding: 20px;\n\tmargin-bottom: 10px;\n\tborder-radius: 10px;\n}\n\nform input, form label, form button {\n\tdisplay: block;\n\twidth: 100%;\n\tmargin-bottom: 10px;\n}\n\nform input {\n\tfont-size: 24px;\n\theight: 50px;\n\tpadding: 0 20px;\n}\n\nform input:focus {\n\toutline: var(--primary-color);\n}\n\nform button {\n\tborder: none;\n\tbackground: var(--primary-color);\n\tcolor: #FFFF;\n\tfont-size: 18px;\n\tfont-weight: 700;\n\theight: 50px;\n\tcursor: pointer;\n\tmargin-top: 30px;\n}\n\nform button:hover {\n\tbackground: var(--primary-color-dark);\n}\n", "",{"version":3,"sources":["webpack://./frontend/assets/css/style.css"],"names":[],"mappings":"AAEA;CACC,mCAAmC;CACnC,qCAAqC;AACtC;;AAEA;CACC,sBAAsB;CACtB,aAAa;AACd;;AAEA;CACC,SAAS;CACT,UAAU;CACV,gCAAgC;CAChC,wBAAwB;CACxB,gBAAgB;CAChB,gBAAgB;AACjB;;AAEA;CACC,gBAAgB;CAChB,iBAAiB;CACjB,iBAAiB;CACjB,aAAa;CACb,mBAAmB;CACnB,mBAAmB;AACpB;;AAEA;CACC,cAAc;CACd,WAAW;CACX,mBAAmB;AACpB;;AAEA;CACC,eAAe;CACf,YAAY;CACZ,eAAe;AAChB;;AAEA;CACC,6BAA6B;AAC9B;;AAEA;CACC,YAAY;CACZ,gCAAgC;CAChC,YAAY;CACZ,eAAe;CACf,gBAAgB;CAChB,YAAY;CACZ,eAAe;CACf,gBAAgB;AACjB;;AAEA;CACC,qCAAqC;AACtC","sourcesContent":["@import url('https://fonts.googleapis.com/css2?family=Open+Sans:wght@300&family=Titillium+Web:wght@200&display=swap');\n\n:root {\n\t--primary-color:  rgb(13, 106, 134);\n\t--primary-color-dark:  rgb(9, 48, 56);\n}\n\n* {\n\tbox-sizing: border-box;\n\toutline: none;\n}\n\nbody {\n\tmargin: 0;\n\tpadding: 0;\n\tbackground: var(--primary-color);\n\tfont-family: 'Open sans';\n\tfont-size: 1.3em;\n\tline-height: 1.5;\n}\n\n.container {\n\tmax-width: 640px;\n\tmargin: 50px auto;\n\tbackground: #ffff;\n\tpadding: 20px;\n\tmargin-bottom: 10px;\n\tborder-radius: 10px;\n}\n\nform input, form label, form button {\n\tdisplay: block;\n\twidth: 100%;\n\tmargin-bottom: 10px;\n}\n\nform input {\n\tfont-size: 24px;\n\theight: 50px;\n\tpadding: 0 20px;\n}\n\nform input:focus {\n\toutline: var(--primary-color);\n}\n\nform button {\n\tborder: none;\n\tbackground: var(--primary-color);\n\tcolor: #FFFF;\n\tfont-size: 18px;\n\tfont-weight: 700;\n\theight: 50px;\n\tcursor: pointer;\n\tmargin-top: 30px;\n}\n\nform button:hover {\n\tbackground: var(--primary-color-dark);\n}\n"],"sourceRoot":""}]);
// Exports
